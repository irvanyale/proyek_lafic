...
public class BarangHilang {
    ...
    public String getBARANG_HILANG_ID() {
        return BARANG_HILANG_ID;
    }

    public void setBARANG_HILANG_ID(String BARANG_HILANG_ID) {
        this.BARANG_HILANG_ID = BARANG_HILANG_ID;
    }
    ...
    public String getTANGGAL_HILANG() {
        return TANGGAL_HILANG;
    }

    public void setTANGGAL_HILANG(String TANGGAL_HILANG) {
        this.TANGGAL_HILANG = TANGGAL_HILANG;
    }

    public String getTANGGAL_KETEMU() {
        return TANGGAL_KETEMU;
    }

    public void setTANGGAL_KETEMU(String TANGGAL_KETEMU) {
        this.TANGGAL_KETEMU = TANGGAL_KETEMU;
    }

    public String getLOKASI_HILANG() {
        return LOKASI_HILANG;
    }

    public void setLOKASI_HILANG(String LOKASI_HILANG) {
        this.LOKASI_HILANG = LOKASI_HILANG;
    }

    public String getLOKASI_KETEMU() {
        return LOKASI_KETEMU;
    }

    public void setLOKASI_KETEMU(String LOKASI_KETEMU) {
        this.LOKASI_KETEMU = LOKASI_KETEMU;
    }
